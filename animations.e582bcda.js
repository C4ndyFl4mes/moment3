...
})({"79FJn":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "0a86d8f6e582bcda";
"use strict";
...
},{}],"hF9Zi":[function(require,module,exports,__globalThis) {
...
powerfulBTN.addEventListener("mouseleave", ()=>{
    if (activeCooldown) toggleCooldown();
});
function toggleCooldown() {
    ...
    if (activeCooldown) {
        ...
        function updateCooldownForward() {
            ...
            if (elapsed > cooldownTime) powerfulBTN.textContent = "Sl\xe4pp";
            ...
            if (progress < 100) animationFrameID = requestAnimationFrame(updateCooldownForward);
        }
        ...
        function updateCooldownBackward() {
            ...
            if (progress > 0) animationFrameID = requestAnimationFrame(updateCooldownBackward);
        }
...
},{}]},["79FJn","hF9Zi"], "hF9Zi", "parcelRequire94c2")

//# sourceMappingURL=animations.e582bcda.js.map
