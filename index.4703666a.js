!function(){let t=document.getElementById("anime-list");async function e(i=1){if(localStorage.getItem("animePagesofLists")){let l=JSON.parse(localStorage.getItem("animePagesofLists"));for(let o of l){if(o.page===i){var s;s=o.list,t.innerHTML="",s.forEach(e=>{let a=e.title_english;null===e.title_english&&(a=e.title),t.innerHTML+=`<article class=anime-list-item>
                    <h2>${a}</h2>
                    <div>
